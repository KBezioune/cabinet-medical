...
import { getPlanningByUser, getPointagesByDateRange } from '../../lib/localData'
...
export default function MySchedule() {
  ...
  useEffect(() => {
    ...
    setPlanning(getPlanningByUser(user.id))
    setPointages(getPointagesByDateRange([user.id], dateFrom, dateTo))
  }, [weekRef, user.id])

  const getPlanForDay = (dayIndex) =>
    planning.find(p => p.jour_semaine === dayIndex + 1)

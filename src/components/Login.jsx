  ...
  useEffect(() => {
    ...
    timerRef.current = setInterval(() => {
      ...
      if (remaining <= 0) {
        ...
        setLocked(false); setAttempts(0); setError(''); setPassword('')
          ...
          {locked ? (
            <div className="lockout-screen">
              ...
              <div className="lockout-subtitle">
                ...
                Réessayez dans <strong>{countdown} s</strong>.
              </div>
            </div>
          ) : (
            <form className="login-form" onSubmit={handleSubmit} noValidate>
              ...
              <button type="submit" className="login-submit" disabled={!password.trim() || loading}>
                {loading ? (

...
import { updatePointage, deletePointage } from '../../lib/localData'
        ...
        <div className="modal-body">
          ...
          <div className="form-group">
            ...
            <span style={{ fontSize: '0.75rem', color: 'var(--gray-400)' }}>
              Laisser vide si l'assistante est encore en service
            </span>
          </div>
          ...
          <div className="form-group">
            ...
            <textarea value={note} onChange={e => setNote(e.target.value)} rows={2}
              placeholder="Remarque, justificatif..." style={{ resize: 'vertical' }} />
          </div>
        </div>

...
import { getAssistants, getPointagesByUserAndMonth } from '../../lib/localData'
...
export default function MonthlyExport() {
  ...
  useEffect(() => {
    ...
    assistants.forEach(u => {
      byUser[u.id] = getPointagesByUserAndMonth(u.id, from, to)
    })
              ...
              <div className="user-summary-stats">
                ...
                <div className="summary-stat">
                  <span className="summary-stat-value">
                    {jours > 0 ? minutesToHHMM(Math.round(totalMin / jours)) : '—'}
                  </span>
